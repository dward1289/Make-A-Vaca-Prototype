...
@implementation SavedVacasViewController
...
- (void)viewDidLoad {
  ...
  tableView1.backgroundColor = [UIColor colorWithRed:0.4 green:0.8 blue:1.0 alpha:1.0];
  [tableView1 release];
  ...
  [tableViewSection1Data setObject:[NSNumber numberWithBool:YES] forKey:@"customHeaderView"];
  ...
  tableViewCell1.textLabel.text = @"Myrtle Beach";
  ...
  tableViewCell2.textLabel.text = @"New York";
  ...
  UIView *tableViewHeaderView1 = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 6)] autorelease];
  [tableViewSection1Data setObject:tableViewHeaderView1 forKey:@"headerView"];
  [tableViewSection1Data setObject:[NSNumber numberWithFloat:0] forKey:@"customHeaderViewHeight"];
  ...
  tableViewCell3.textLabel.text = @"Disney Land";
  ...
  tableViewCell4.textLabel.text = @"Hollywood";
  ...
  tableViewCell5.textLabel.text = @"Bahamas Cruise";
  tableViewCell5.detailTextLabel.text = @"Subtitle";
  tableViewCell5.accessoryType = UITableViewCellAccessoryNone;
  tableViewCell5.textLabel.textColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0];
  ...
  tableViewCell6.textLabel.text = @"Miami Beach";
  tableViewCell6.detailTextLabel.text = @"Subtitle";
  tableViewCell6.accessoryType = UITableViewCellAccessoryNone;
  tableViewCell6.textLabel.textColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0];
  ...
  navigationBar1.topItem.title = @"Saved Vacas";
